...
class ReceiveController: UIViewController {
    override func viewDidLoad() {
        ...
        addressLabel.text = Manager.shared.adapter.receiveAddress.toString(bounceable: false)
    ...
    @objc private func copyToClipboard() {
        UIPasteboard.general.string = Manager.shared.adapter.receiveAddress.toRaw()
